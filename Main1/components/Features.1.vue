  ...
  <section class="service-one" id="features">
    <div class="container">
      <div class="block-title text-center">
        <h2 class="block-title__title">快看看世界各国 <span>自杀率</span> 数据</h2><!-- /.block-title__title -->
      </div><!-- /.block-title -->
      <div class="text1">
        <p><i class="fa fa-check"></i>    自杀率与国家是否发达无关</p>
        <p><i class="fa fa-check"></i>    纵观全球来看，非洲自杀率>欧洲自杀率>亚洲自杀率>南美洲自杀率>北美洲自杀率</p>
        <p><i class="fa fa-check"></i>    全球的自杀率较高，在前几年全球的自杀人数都有显著的升高。</p>
      </div>
