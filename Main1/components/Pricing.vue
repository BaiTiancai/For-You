  ...
  <section class="pricing-one" id="pricing">
    <div class="container">
      <div class="block-title text-center">
        <h2 class="block-title__title">查看 <span>不同客观因素</span> 对 <br> 抑郁症患者数量的影响程度</h2><!-- /.block-title__title -->
      </div><!-- /.block-title -->
      <div class="text1">
        <p><i class="fa fa-check"></i>    从经济发展水平来看，初期随着经济增长收入增加，抑郁症患者群体出现下降趋势。但中后期，各种社会 <br> 问题的出现和生活压力大加大，抑郁症患者数量随之上升。</p>
        <p><i class="fa fa-check"></i>    互联网普及率导致人们了解到的相关信息增加，信息复杂程度使人们被迫接受更多元的信息，加大了抑郁 <br> 出现的可能性。</p>
        <p><i class="fa fa-check"></i>    教育、人口老龄化、社会宽容度、就业结构等因素对抑郁症的数量以及分布也产生着较大的影响。</p>
        <p><i class="fa fa-check"></i>    抑郁症对于年龄越大的人，其影响程度越深，得到关注和治疗的比率更低，需要进行更长时间的残疾调整 <br> 生命年。</p>
      </div>
      <div class="com-container" style="position: relative">
...
import { mapState } from 'vuex'
    export default {
      ...
      methods: {
        initChart () {
          this.chartInstane = this.$echarts.init(this.$refs.suirate_ref, 'vintage')
          const initOption = {
            grid: {
              left: '3%',
              top: '35%',
