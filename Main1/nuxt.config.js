...
export default {
  ...
  */
  head: {
    ...
    script: [
      ...
      { src: "/assets/lib/echarts.min.js", type: "text/javascript", body: true },
      { src: "/assets/theme/chalk.js", type: "text/javascript", body: true },
      { src: "/assets/theme/vintage.js", type: "text/javascript", body: true },
    ],
  },
  /*
  ...
  */
  plugins: [
    { src: '~/plugins/proto.js', ssr: false },
